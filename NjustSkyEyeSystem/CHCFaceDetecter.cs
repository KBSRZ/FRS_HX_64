...
namespace NjustSkyEyeSystem
{
    class CHCFaceDetecter
    {
        ...
        /// <summary>
        /// 找到一个最符合搜索条件的ID，顺便删除过期的人脸且不满足数目不满足的人脸
        /// </summary>
        /// <returns></returns>
        ...
        public CHCFaceDetecter(Capture cap, System.Windows.Forms.PictureBox RealPlayWnd)
        {
            this.cap = cap;
            ...
            while (DetectStatue)
            {
                ...
                try
                {
                   ...
                   ///
                    ...
                    cap.DetectFace4CHC(catchFaceImageMap[faceId].faceImgSet, 0);
