...
namespace FRSServerHttp.Server.Websocket
{
    public static class Hybi13Handler
    {
        ...
        public static FrameType GetFrameType(List<byte> data)
        {
            if (data.Count >= 2)
            return (FrameType)(data[0] & 15);
            return FrameType.Continuation;
        }
        public static void ReceiveData(List<byte> data)
        {
        ...
        public static void ProcessFrame(FrameType frameType, byte[] data)
        {
            switch (frameType)
            {
            ...
            case FrameType.Text:
                ...
                break;
            default:
                Log.Debug("Received unhandled " + frameType);
                break;
            }
        }
        ...
        {
            Log.Debug("Building Hybi-14 Response");
            ...
            var responseKey =  CreateResponseKey(request.SecWebSocketKey.Trim());
